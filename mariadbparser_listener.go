...
// MariaDBParserListener is a complete listener for a parse tree produced by MariaDBParser.
type MariaDBParserListener interface {
	...
	// EnterSetStatementFor is called when entering the setStatementFor production.
	EnterSetStatementFor(c *SetStatementForContext)
	...
	// EnterSequenceSpec is called when entering the sequenceSpec production.
	EnterSequenceSpec(c *SequenceSpecContext)
	...
	// EnterTableOptionEncrypted is called when entering the tableOptionEncrypted production.
	EnterTableOptionEncrypted(c *TableOptionEncryptedContext)
	...
	// EnterShowRelayLogEvents is called when entering the showRelayLogEvents production.
	EnterShowRelayLogEvents(c *ShowRelayLogEventsContext)
	...
	// EnterShowCreatePackage is called when entering the showCreatePackage production.
	EnterShowCreatePackage(c *ShowCreatePackageContext)
	...
	// EnterShowInnoDBStatus is called when entering the showInnoDBStatus production.
	EnterShowInnoDBStatus(c *ShowInnoDBStatusContext)
	...
	// EnterShowUserstatPlugin is called when entering the showUserstatPlugin production.
	EnterShowUserstatPlugin(c *ShowUserstatPluginContext)

	// EnterShowExplain is called when entering the showExplain production.
	EnterShowExplain(c *ShowExplainContext)

	// EnterShowPackageStatus is called when entering the showPackageStatus production.
	EnterShowPackageStatus(c *ShowPackageStatusContext)

	// EnterExplainForConnection is called when entering the explainForConnection production.
	EnterExplainForConnection(c *ExplainForConnectionContext)
	...
	// EnterFormatJsonStatement is called when entering the formatJsonStatement production.
	EnterFormatJsonStatement(c *FormatJsonStatementContext)
	...
	// EnterEncryptedLiteral is called when entering the encryptedLiteral production.
	EnterEncryptedLiteral(c *EncryptedLiteralContext)
	...
	// ExitSetStatementFor is called when exiting the setStatementFor production.
	ExitSetStatementFor(c *SetStatementForContext)
	...
	// ExitSequenceSpec is called when exiting the sequenceSpec production.
	ExitSequenceSpec(c *SequenceSpecContext)
	...
	// ExitTableOptionEncrypted is called when exiting the tableOptionEncrypted production.
	ExitTableOptionEncrypted(c *TableOptionEncryptedContext)
	...
	// ExitShowRelayLogEvents is called when exiting the showRelayLogEvents production.
	ExitShowRelayLogEvents(c *ShowRelayLogEventsContext)
	...
	// ExitShowCreatePackage is called when exiting the showCreatePackage production.
	ExitShowCreatePackage(c *ShowCreatePackageContext)
	...
	// ExitShowInnoDBStatus is called when exiting the showInnoDBStatus production.
	ExitShowInnoDBStatus(c *ShowInnoDBStatusContext)
	...
	// ExitShowUserstatPlugin is called when exiting the showUserstatPlugin production.
	ExitShowUserstatPlugin(c *ShowUserstatPluginContext)

	// ExitShowExplain is called when exiting the showExplain production.
	ExitShowExplain(c *ShowExplainContext)

	// ExitShowPackageStatus is called when exiting the showPackageStatus production.
	ExitShowPackageStatus(c *ShowPackageStatusContext)

	// ExitExplainForConnection is called when exiting the explainForConnection production.
	ExitExplainForConnection(c *ExplainForConnectionContext)
	...
	// ExitFormatJsonStatement is called when exiting the formatJsonStatement production.
	ExitFormatJsonStatement(c *FormatJsonStatementContext)
	...
	// ExitEncryptedLiteral is called when exiting the encryptedLiteral production.
	ExitEncryptedLiteral(c *EncryptedLiteralContext)
